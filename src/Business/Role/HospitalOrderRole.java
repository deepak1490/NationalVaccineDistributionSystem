...
import UserInterface.Provider.HospitalOrderWorkAreaJPanel;
...
public class HospitalOrderRole extends Role {
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, Cdc ecoSystem, DB4OUtil db4o) {
        return new HospitalOrderWorkAreaJPanel(userProcessContainer, account, organization, enterprise, ecoSystem, db4o);
    }
