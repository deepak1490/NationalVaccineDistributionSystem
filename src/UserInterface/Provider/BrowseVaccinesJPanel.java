 ...
 * @author Deepak
 */
public class BrowseVaccinesJPanel extends javax.swing.JPanel {
    ...
    public BrowseVaccinesJPanel(JPanel upc, UserAccount ua, Organization org, ProvidersEnterprise enterprise, Cdc system) {
        initComponents();
        this.upc = upc;
        this.ua = ua;
        this.org = org;
    ...
    private void populateSearchedVaccine(String keyword) {
        if (keyword.equals(null) || keyword.equals("")) {
            JOptionPane.showMessageDialog(null, "Please enter a vaccine name to search");
            return;
        }
        DefaultTableModel dtm = (DefaultTableModel) vaccineDetailsJTable.getModel();
        dtm.setRowCount(0);
    ...
    private void initComponents() {
        ...
        searchProductNameJText = new javax.swing.JTextField();
        ...
        add(searchProductNameJText, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 100, 80, -1));

        searchProductButton.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        searchProductButton.setText("Search By Vaccine Name");
        searchProductButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                searchProductButtonActionPerformed(evt);
            }
        });
        add(searchProductButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 100, -1, -1));
    ...
    private void searchProductButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchProductButtonActionPerformed
        // TODO add your handling code here:
        String searchProduct = searchProductNameJText.getText();
        populateSearchedVaccine(searchProduct);
    ...
    private void checkOutJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkOutJButtonActionPerformed
        ...
        if (orderItemJTable.getRowCount() != 0) {
            ...
            if (addedOrder != null) {
                ...
                if (ua.getRole() instanceof HospitalOrderRole) {
                    request.setRequestType("Hospital Order Request");
                }
                if (ua.getRole() instanceof PharmacyOrderRole) {
                    request.setRequestType("Pharmacy Order Request");
                }
    ...
    private void backJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backJButtonActionPerformed
        ...
        if (isCheckedOut == false) {
            int newAvailability;
            for (OrderItem orderItem : order.getOrderItemList()) {
//                newAvailability = orderItem.getQuantity() + orderItem.getVaccine().getAvailability();
//                orderItem.getVaccine().setAvailability(newAvailability);
                JOptionPane.showMessageDialog(null, "Not checked out");
//                for (InventoryItem inventoryItem : system.getInventoryDirectory().getInventoryList()) {
//                    if (inventoryItem.getVaccine().getID() == orderItem.getVaccine().getID()) {
//                        inventoryItem.setQuantity(newAvailability);
//                    }
//                }
            }
    ...
    private javax.swing.JTextField searchProductNameJText;
