 ...
 * @author Deepak
 */
public class ManagePharmacyPatientCatalogJPanel extends javax.swing.JPanel {
     ...
     */
    public ManagePharmacyPatientCatalogJPanel(JPanel upc, Cdc system, UserAccount userAccount, Organization organization, Enterprise enterprise) {
        initComponents();
    ...
    public void populateTable() {
        ...
        model.setRowCount(0);
        for (Patient patient : userAccount.getEmployee().getPharmacy().getPatientDirectory().getPatientDirectory()) {
    ...
    private void addPatientJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addPatientJButtonActionPerformed
        ...
        try {
            ...
            userAccount.getEmployee().getPharmacy().getPatientDirectory().getPatientDirectory().add(patient);
