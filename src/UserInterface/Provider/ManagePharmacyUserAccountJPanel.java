...
public class ManagePharmacyUserAccountJPanel extends javax.swing.JPanel {
    ...
    public ManagePharmacyUserAccountJPanel(JPanel container, ProvidersEnterprise enterprise, Cdc system) {
        initComponents();
    ...
    public void popData() {
        ...
        for (Organization organization : enterprise.getOrganizationList().getOrganizationList()) {
            for (UserAccount ua : organization.getUserAccountDirectory().getUserAccountList()) {
                if (ua.getEmployee().getPharmacy() != null) {
    ...
    private void initComponents() {
        ...
        add(createUserJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 600, -1, -1));

        nameJTextField.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        add(nameJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 520, 146, -1));

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel1.setText("User Name");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 530, -1, -1));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 200, 375, 179));

        jLabel2.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel2.setText("Password");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 570, -1, -1));

        passwordJTextField.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        add(passwordJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 560, 146, -1));

        jLabel3.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel3.setText("Employee");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 440, -1, -1));
        ...
        add(employeeJComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 440, 225, -1));
        ...
        add(backjButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 660, 112, -1));

        jLabel5.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel5.setText("Organization");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 400, -1, -1));
        ...
        add(organizationJComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 400, 225, -1));

        jLabel4.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel4.setText("Role");
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 490, -1, -1));

        roleJComboBox.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        roleJComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        add(roleJComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 480, 225, -1));

        jLabel9.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel9.setText("Manage Pharmacy User Accounts Page");
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 70, -1, -1));
    ...
    private void createUserJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createUserJButtonActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "User Account added sucessfully");
        nameJTextField.setText(null);
        passwordJTextField.setText(null);
        popData();
