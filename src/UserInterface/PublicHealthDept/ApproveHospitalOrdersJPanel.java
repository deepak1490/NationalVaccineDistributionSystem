 ...
 * @author Deepak
 */
public class ApproveHospitalOrdersJPanel extends javax.swing.JPanel {
    ...
    public ApproveHospitalOrdersJPanel(JPanel userProcessContainer,
    ...
    private void populateTable() {
        ...
        for (WorkRequest request : enterprise.getWorkQueue().getWorkRequestList()) {
            ...
            if (request.getRequestType().equals("Hospital Order Request")) {
    ...
    private void initComponents() {
        ...
        ordersTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Order ID", "Hospital Name", "Approver Name", "Order Status"
            }
        ));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 170, 505, 88));

        assignToMeButton.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        add(assignToMeButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 310, -1, -1));
        ...
        add(backButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 510, -1, -1));
        ...
        add(approveOrder, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 310, -1, -1));

        rejectOrder.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        add(rejectOrder, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 310, -1, -1));

        orderDetailsButton.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        add(orderDetailsButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 310, -1, -1));
        ...
        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 370, 375, 92));

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel1.setText("Approve Hospital Orders Page");
